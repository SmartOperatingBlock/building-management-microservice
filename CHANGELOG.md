## [1.4.24](https://github.com/SmartOperatingBlock/building-management-microservice/compare/1.4.23...1.4.24) (2023-12-27)


### Dependency updates

* **core-deps:** update plugin kotlin-serialization to v1.9.22 ([e692a73](https://github.com/SmartOperatingBlock/building-management-microservice/commit/e692a732a3dac67e0c62f91664295dee42d54965))
* **deps:** update dependency com.fasterxml.jackson.module:jackson-module-kotlin to v2.16.1 ([fc04b04](https://github.com/SmartOperatingBlock/building-management-microservice/commit/fc04b049868e1a149f2828dbe9fd600ba0443ee2))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.85 ([3bf1de2](https://github.com/SmartOperatingBlock/building-management-microservice/commit/3bf1de275e0ae4d16de29d101d85ccd79cd2b1b2))
* **deps:** update plugin org.danilopianini.gradle-pre-commit-git-hooks to v1.1.17 ([13bd245](https://github.com/SmartOperatingBlock/building-management-microservice/commit/13bd24516cddec8f070ee3681dd7d784a62ba023))
...
* **deps:** update dependency de.flapdoodle.embed:de.flapdoodle.embed.mongo to v4.9.1 ([3fcbffb](https://github.com/SmartOperatingBlock/building-management-microservice/commit/3fcbffb7fc078396973218aa6885b2f009dc9eb6))
* **deps:** update dependency de.flapdoodle.embed:de.flapdoodle.embed.mongo to v4.9.2 ([a28bf4b](https://github.com/SmartOperatingBlock/building-management-microservice/commit/a28bf4bc62df668312b6f79975ca125edce8a469))
* **deps:** update dependency io.confluent:kafka-json-serializer to v7.5.0 ([5ecda6c](https://github.com/SmartOperatingBlock/building-management-microservice/commit/5ecda6ce3c37dbebece07ba514a6535a5877e2b9))
* **deps:** update dependency org.apache.kafka:kafka-clients to v7.5.0-ce ([5c61b30](https://github.com/SmartOperatingBlock/building-management-microservice/commit/5c61b307d0654de7bb9f519167ac15296c392163))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.47 ([8eb2961](https://github.com/SmartOperatingBlock/building-management-microservice/commit/8eb2961eda63a90ff7bf55969f5dac4cca16e025))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.48 ([ac48ac4](https://github.com/SmartOperatingBlock/building-management-microservice/commit/ac48ac4777eca161f1f094f9432e40d97b138f4a))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.49 ([3749f2d](https://github.com/SmartOperatingBlock/building-management-microservice/commit/3749f2dbccd27fdc3e99a5ce16cc89dbd8e2e08b))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.50 ([9139866](https://github.com/SmartOperatingBlock/building-management-microservice/commit/91398667ba2dc7485be9e45cfc5bf8b0ba672e94))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.52 ([3cf74bf](https://github.com/SmartOperatingBlock/building-management-microservice/commit/3cf74bf8d556c61c1c4eaa38ffd8e82d6732fe2d))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.53 ([f81178a](https://github.com/SmartOperatingBlock/building-management-microservice/commit/f81178ab06666761a609c790d342758cb31f0b68))
* **deps:** update kotest to v5.7.0 ([abdd5e5](https://github.com/SmartOperatingBlock/building-management-microservice/commit/abdd5e59b08f11d10f30875acda4f92ede318c95))
* **deps:** update kotest to v5.7.1 ([d222ddf](https://github.com/SmartOperatingBlock/building-management-microservice/commit/d222ddf5b7c4026f1267a52b7b749baa1d2877d5))
* **deps:** update ktor to v2.3.4 ([083edf0](https://github.com/SmartOperatingBlock/building-management-microservice/commit/083edf042257f4b75f8dc64c11a023b34095a0b4))


### Documentation

* **deps:** update plugin dokka to v1.9.0 ([354b208](https://github.com/SmartOperatingBlock/building-management-microservice/commit/354b208b87b88a2c16d4f6a67de97048be07e1c5))
...
* **core-deps:** update plugin kotlin-serialization to v1.9.0 ([c6d5e76](https://github.com/SmartOperatingBlock/building-management-microservice/commit/c6d5e76d80d2e639a2cbd8dcbac10152f4cba651))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.40 ([2729fd7](https://github.com/SmartOperatingBlock/building-management-microservice/commit/2729fd79fb4c9a2e250de7e363d6b53d741640a6))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.41 ([77a1bc7](https://github.com/SmartOperatingBlock/building-management-microservice/commit/77a1bc7ccee84d2e6e766df2f45b34d890fc4ed8))
* **deps:** update plugin kotlin-qa to v0.47.0 ([53169b8](https://github.com/SmartOperatingBlock/building-management-microservice/commit/53169b89a1a7799d54d01fa18e9fcc0bb5145566))

## [1.4.10](https://github.com/SmartOperatingBlock/building-management-microservice/compare/1.4.9...1.4.10) (2023-07-07)


### Dependency updates

* **core-deps:** update dependency org.jetbrains.kotlin:kotlin-stdlib to v1.9.0 ([cb25ae3](https://github.com/SmartOperatingBlock/building-management-microservice/commit/cb25ae3059434f84f86b417352e69b030493918a))
* **deps:** update dependency ch.qos.logback:logback-classic to v1.4.8 ([da93369](https://github.com/SmartOperatingBlock/building-management-microservice/commit/da93369fcdb9bc8a2fc53a49eaef6e51ded291b3))
* **deps:** update dependency com.azure:azure-digitaltwins-core to v1.3.10 ([710763d](https://github.com/SmartOperatingBlock/building-management-microservice/commit/710763dfd9b0ef80a9c9fb72212b772219a74565))
* **deps:** update dependency gradle to v8.2 ([bc0a6be](https://github.com/SmartOperatingBlock/building-management-microservice/commit/bc0a6bebeca87186c11bd3311ce8075b6afc72be))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.36 ([6c6d535](https://github.com/SmartOperatingBlock/building-management-microservice/commit/6c6d535b6ca1718c4b547244b768d57d94b6d295))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.37 ([ea542e6](https://github.com/SmartOperatingBlock/building-management-microservice/commit/ea542e6ae3ac70abaaf1737d27036771c157f36c))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.38 ([0b76188](https://github.com/SmartOperatingBlock/building-management-microservice/commit/0b761881962475d6ae888cc1444a2777b94b8cd3))
* **deps:** update dependency semantic-release-preconfigured-conventional-commits to v1.1.39 ([610ebd9](https://github.com/SmartOperatingBlock/building-management-microservice/commit/610ebd9dd89b48ba68a310c3bcddd58bb407fab5))
* **deps:** update ktor to v2.3.2 ([953b143](https://github.com/SmartOperatingBlock/building-management-microservice/commit/953b1432909e0bb172eb296e7af0b03e12657255))
* **deps:** update plugin com.gradle.enterprise to v3.13.4 ([2a3d15d](https://github.com/SmartOperatingBlock/building-management-microservice/commit/2a3d15d9181e561359ca40c492a864bf6c206daa))
* **deps:** update plugin kotlin-qa to v0.45.0 ([eebad6b](https://github.com/SmartOperatingBlock/building-management-microservice/commit/eebad6b11857207eb4995605d8816fa2f4284dfd))
* **deps:** update plugin kotlin-qa to v0.46.0 ([994cb93](https://github.com/SmartOperatingBlock/building-management-microservice/commit/994cb9361eea774eead30e701e2302b8c1971318))
* **deps:** update plugin kotlin-qa to v0.46.1 ([728f4ee](https://github.com/SmartOperatingBlock/building-management-microservice/commit/728f4ee47ff0af0df374c8d7e6490ae46070a375))


### Build and continuous integration

* **deps:** update smartoperatingblock/release-and-delivery-action action to v1.0.3 ([49dc0ae](https://github.com/SmartOperatingBlock/building-management-microservice/commit/49dc0ae44123f5eea10cd096e1bbbfceac882e9f))


### Style improvements

* correct code to adhere to new kotlin qa rules ([48540f5](https://github.com/SmartOperatingBlock/building-management-microservice/commit/48540f5f060d3a03a6f6c89a8f9c4d66d772434f))
